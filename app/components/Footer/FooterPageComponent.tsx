  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-200 py-8 w-full">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start px-4">
        <div className="flex flex-col md:flex-row w-full md:w-1/2 mb-6 md:mb-0 leading-9">
          ...
          <div className="w-full md:w-1/2 leading-9">
        ...
        <div className="flex flex-col md:flex-row w-full md:w-1/2 leading-9">
          <div className="w-full md:w-1/2 mb-6 md:mb-0">
