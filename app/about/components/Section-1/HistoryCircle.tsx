...
const HistoryCircle = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <div className=" mt-10">
        <Image src={EyesArrow} alt="eyes-arrow" height={165} />
      </div>
      <div className=" bg-blueDarkColor text-white absolute bottom-[757px] rounded-full flex items-center justify-center w-[695px] h-[669px]">
