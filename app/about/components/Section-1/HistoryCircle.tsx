...
const HistoryCircle = () => {
  return (
    <div className="flex flex-col items-center h-full relative  top-0 justify-center  mt-0  2xl:mt-[40px] ">
      ...
      <div className=" bg-blueDarkColor text-white rounded-full  mb-[45px] 2xl:mb-[68px] flex items-center justify-center  w-[371px] 2xl:w-[675px] h-[624px] 2xl:h-[735px]">
        <Image
          src={EyesArrow}
          alt="eyes-arrow"
          height={140}
          className="absolute  2xl:top-[14%] top-24  h-[130px] 2xl:h-[140px] "
        />
